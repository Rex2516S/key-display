...
class KeyDisplayApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Key display by kyle_A_10000")
        # 缩小窗口尺寸
        self.root.geometry("500x300")
        self.root.configure(bg='#C6C6C6')  # Minecraft 灰色背景
        
        # 设置窗口置顶
        self.root.attributes('-topmost', True)
        
        # 创建画布
        self.canvas = tk.Canvas(root, width=350, height=250, bg='#C6C6C6', highlightthickness=0)
        self.canvas.pack()
    ...
    def draw_key(self, x, y, width, height, text, is_pressed):
        ...
        # 绘制文字
        self.canvas.create_text(x+width/2, y+height/2, text=text, font=('Arial', 12, 'bold'))
    ...
    def draw_mouse_button(self, x, y, width, height, text, is_pressed, cps):
        ...
        # 绘制文字
        self.canvas.create_text(x+width/2, y+height/2-6, text=text, font=('Arial', 10, 'bold'))
    ...
    def draw_interface(self):
        ...
        # 绘制标题
        self.canvas.create_text(250, 15, text="Key display", font=('Arial', 12, 'bold'))
